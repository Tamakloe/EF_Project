...
namespace RateMyTestProject
{
    ...
    public class AmenityDalTest
    {
        ...
        public void GetAvgRatingTest()
        {
            ...
            IQueryable expected = target.GetAvgRating(); // TODO: Initialize to an appropriate value
            IQueryable actual;
        ...
        public void GetParkingDetailsTest()
        {
            ...
            IQueryable expected = target.GetParkingDetails(lat1, long1); // TODO: Initialize to an appropriate value
            IQueryable actual;
