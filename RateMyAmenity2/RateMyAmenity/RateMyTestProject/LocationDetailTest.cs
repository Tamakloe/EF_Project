...
namespace RateMyTestProject
{
    ...
    /// <summary>
    ///This is a test class for LocationDetailTest and is intended
    ///to contain all LocationDetailTest Unit Tests
    ///</summary>
    [TestClass()]
    public class LocationDetailTest
    {
        ...
        /// <summary>
        ///A test for LocationDetail Constructor
        ///</summary>
        ...
        public void LocationDetailConstructorTest()
        {
            LocationDetail target = new LocationDetail();
